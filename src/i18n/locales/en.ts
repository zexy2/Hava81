  ...
  hava81: {
    ...
    decision: {
      ...
      actions: {
        ...
        stable: 'No material weather risk stands out in the near forecast.',
        unavailable: 'Near-term decision data is not ready yet.',
      },
      compactActions: {
        rain: '{{time}} · Rain {{probability}}%',
        rainWithAmount: '{{time}} · Rain {{probability}}% · {{amount}}',
        rainAmount: '{{time}} · Rain {{amount}}',
        wind: 'Wind {{speed}} · Take care outdoors',
        heat: 'Feels like {{temperature}} · Plan shade and water',
        cold: 'Feels like {{temperature}} · Take care in the cold',
        airQuality: 'AQI {{aqi}}/5 · Reduce outdoor activity',
        uv: 'Modeled UV peak {{uv}} · Plan sun protection',
        outdoor: 'Calmer weather · Around {{time}}',
        stable: 'No material weather risk stands out',
        unavailable: 'Decision data is being prepared',
      },
      notAvailable: '—',
    ...
    dailyPlan: {
      ...
      reasons: {
        ...
        clear: 'No material weather risk stands out',
      },
      safetyNote: 'Weather-based decision support only; it is not a safety guarantee.',
      methodDetails: 'Data coverage and method',
      note: 'The Hava81 Score combines feels-like temperature, precipitation probability and amount, sustained wind and gusts, air quality, UV, visibility and severe-weather signals. Current air quality is used only for the matching current hour and is not copied into future hours. If a field is unavailable, it falls back to the remaining verified signals with lower data coverage.',
    },
    commute: {
    ...
    activities: {
      ...
      score: {
        ...
        activityImpact: 'General weather score → activity score: {{value}}',
        explanation:
