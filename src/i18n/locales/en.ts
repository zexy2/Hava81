  ...
  hava81: {
    ...
    decision: {
      ...
      actions: {
        ...
        wind: 'Wind may reach {{speed}} m/s; use extra care outdoors.',
        heat: 'Temperature may reach {{temperature}}°C; plan for shade and water.',
        cold: 'Temperature may fall to {{temperature}}°C; watch for icy conditions.',
    ...
    dailyPlan: {
      ...
      note: 'The Hava81 Score uses temperature, the 3-hour forecast, rain, wind and air quality. UV is shown as a separate real-data signal; hourly UV weighting is not yet included in the score.',
    },
    commute: {
