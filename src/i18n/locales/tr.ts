...
export const tr = {
  ...
  hava81: {
    ...
    decision: {
      ...
      compactActions: {
        rain: '{{time}} · Yağış %{{probability}}',
        rainWithAmount: '{{time}} · Yağış %{{probability}} · {{amount}}',
        rainAmount: '{{time}} · Yağış {{amount}}',
        wind: 'Rüzgâr {{speed}} · Açık alanda dikkat',
        heat: 'Hissedilen {{temperature}} · Su ve gölge planla',
        cold: 'Hissedilen {{temperature}} · Soğuğa dikkat',
        airQuality: 'AQI {{aqi}}/5 · Dış aktiviteyi azalt',
        uv: 'UV model zirvesi {{uv}} · Korunma planla',
        outdoor: 'Daha sakin hava · {{time}} civarı',
        stable: 'Belirgin hava riski görünmüyor',
        unavailable: 'Karar verisi hazırlanıyor',
      },
      notAvailable: '—',
    ...
    forecastAtlas: {
      ...
      dailyRegion: 'Kaydırılabilir 5 günlük tahmin',
    ...
    dailyPlan: {
      ...
      reasons: {
        ...
        clear: 'Belirgin hava riski görünmüyor',
      },
      safetyNote: 'Yalnız hava koşullarına dayalı karar desteğidir; güvenlik garantisi değildir.',
      methodDetails: 'Veri kapsamı ve yöntem',
    ...
    activities: {
      ...
      score: {
        ...
        detailsTitle: 'Skor detayı',
        activityImpact: 'Genel hava skoru → aktivite skoru: {{value}}',
        explanation:
    ...
    alerts: {
      ...
      waitTitle: '{{city}} · Hava81 · Hava açısından beklemek daha iyi',
      waitBody: '{{time}} civarı hava skoru yaklaşık {{improvement}} puan daha iyi.',
