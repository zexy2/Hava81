...
export const tr = {
  ...
  hava81: {
    ...
    dailyPlan: {
      ...
      note: 'Hava81 Skoru mevcut sıcaklık, 3 saatlik tahmin, yağış, rüzgâr ve hava kalitesi verilerinden hesaplanır. UV verisi bağlı olmadığı için skora dahil değildir.',
    },
  },
  navigation: {
    label: 'Ana gezinme',
