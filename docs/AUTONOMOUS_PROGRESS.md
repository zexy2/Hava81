...
### 2026-09-01 22:18 TRT — exact autonomous continuation checkpoint
- Current remote main: `2fadc5c41c349de7e239092a4eb75dd15ba52c6f` (`fix: expire weather freshness at provider TTL (#585)`). #585 was merged only after exact head `4de63458d7d4dcfa73d7ca6a402deb80d5c4224e` had CodeQL #267 and CI/CD #1379 green plus direct production/root/İstanbul and observer health verification.
- Current main CI/CD: run #1382 (`33548281953`) started for `2fadc5c41c349de7e239092a4eb75dd15ba52c6f`; API and frontend jobs were in progress at the last direct check. Do not rebase/merge the next prepared PRs until this main release is green and public production is directly reverified.
- PR #586 `automation/hava81-optional-evidence-expiry-2211`: exact head `cdd42477e8ecbb93a6202186980c9f699bfcba45`, based on prior main `a268657c0f26d006274de48b1379cae3865f830c`; CodeQL #268 green and CI/CD #1380 still running. It expires stale AQI/UV/pollen/dust/marine optional evidence at provider TTL; local full suite 557/557 + type/lint/build passed. After #585 production is healthy, rebase this branch onto current main with append-only doc preservation, rerun combined gates, verify remote old head before explicit force-with-lease, then require fresh exact-head CI.
- PR #587 `automation/hava81-pages-smoke-window-2215`: exact head `3a04f16a4e5c68e3d9577193e75b23a833657925`, based on prior main `a268657c0f26d006274de48b1379cae3865f830c`; CodeQL #269 and CI/CD #1381 were running. Evidence from main #1378: `gh-pages` push succeeded at 19:00:32Z, old retained shell stayed healthy, exact new root hash appeared at 19:07:29Z (~6m57s), while response advertises `Cache-Control: max-age=600`. PR keeps exact hashes and changes only CI deploy attempt budget 36→120 and deploy timeout 7→12 minutes.
- Production last direct/observer verification before #585 merge: root 200, İstanbul 200, API readiness 200/fresh/no-store, OpenWeather circuit closed, CORS correct, nginx 4002, no production incident. Root disk remains pressure-warning territory around 91% with ~4.4 GiB free; only rebuildable Hava81 validation artifacts were removed. Do not touch active map worktree or production/rollback Docker resources.
- Prioritized next queue: (1) finish #1382 and exact public shell/boot-asset production verification; (2) rebase/validate #586 onto current healthy main and merge when fresh gates green; (3) rebase/validate #587 similarly and merge; (4) confirm the next main deploy's enlarged exact-shell window removes the measured false-negative without weakening hashes; (5) continue fail-closed optional-evidence/lifecycle audit, mobile/accessibility/performance work in separate current-main worktrees; (6) keep reducing disk pressure only with proven rebuildable/merged Hava81 artifacts.
